  ...
  return (
    <div className="scroll-thin relative flex min-h-dvh w-full min-w-0 flex-1 overflow-x-hidden">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -left-48 -top-40 h-72 w-72 rounded-full bg-primary/10 blur-3xl" />
        <div className="absolute -right-32 top-32 h-64 w-64 rounded-full bg-info/10 blur-3xl" />
        <div className="absolute bottom-0 left-1/2 h-80 w-full -translate-x-1/2 rounded-full bg-primary/5 blur-3xl" />
      </div>
      ...
      <div className="relative z-10 w-full min-w-0">
          ...
          >
            <div className="group flex min-w-0 shrink items-center gap-3 rounded-lg">
              ...
              <div className="flex min-w-0 flex-col leading-none">
                ...
                <span className="truncate text-xs font-black uppercase tracking-widest text-zinc-400 mt-1">
                  Event Monitor
                </span>
              </div>
            </div>
            ...
            <div className="ml-auto flex w-full min-w-0 items-center justify-end gap-2 sm:w-auto">
              <Link
                ...
                className="inline-flex cursor-pointer items-center gap-2 rounded-lg border border-primary/35 bg-primary px-4 py-2 text-xs font-black uppercase tracking-widest text-primary-foreground transition-all duration-200 hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring active:scale-95 shadow-sm shadow-primary/20"
              >
        ...
        <main id="top" className="mx-auto flex w-full max-w-7xl min-w-0 flex-col gap-14 px-4 py-8 md:gap-20 md:px-6 md:py-12">
          <section className="grid min-w-0 items-start gap-8 lg:grid-cols-2 lg:gap-10">
            <div className="flex min-w-0 flex-col gap-6">
              <div className="flex flex-wrap items-center gap-2">
                <Badge variant="outline" className="border-border/70 bg-card/70 px-3 py-1 text-xs font-black uppercase tracking-widest text-foreground">
                  Realtime event telemetry
                </Badge>
                <Badge variant="outline" className="border-border/70 bg-card/70 px-3 py-1 text-xs font-black uppercase tracking-widest text-zinc-400">
                  Built for agents, jobs, services
                </Badge>
              </div>

              <div className="space-y-4">
                <p className="text-xs font-black uppercase tracking-widest text-zinc-400 ml-1">Overview</p>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="rounded-xl border border-border/60 bg-card/80 p-4">
                  <div className="mb-2 flex items-center gap-2 text-xs font-black uppercase tracking-widest text-zinc-400">
                ...
                <div className="flex flex-col gap-3 rounded-2xl border border-border/60 bg-background/70 px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <p className="text-xs font-black uppercase tracking-widest text-zinc-400">Live status</p>
                ...
                <div className="grid min-w-0 gap-3 sm:grid-cols-2">
                  <Card className="min-w-0 border-primary/15 bg-background/60 shadow-none">
                    <CardHeader className="pb-2">
                      ...
                      <CardDescription className="text-xs font-medium leading-normal">Chronological timeline for "chain of thought" trails.</CardDescription>
                    </CardHeader>
                  ...
                  <Card className="min-w-0 border-info/15 bg-background/60 shadow-none">
                    <CardHeader className="pb-2">
                      <CardTitle className="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-info">
                  ...
                  <pre className="w-full max-w-full overflow-x-auto rounded-xl border border-border/60 bg-card/60 p-3 text-xs leading-5 text-foreground sm:text-xs font-mono">
          ...
          <section id="problem" className="space-y-6">
            <div className="space-y-3">
              <p className="text-xs font-black uppercase tracking-widest text-zinc-400 ml-1">Problem</p>
                ...
                return (
                  <Card key={card.title} className="border-border/70 bg-card/70 shadow-none hover:bg-card/80 transition-colors">
                    <CardHeader>
                      ...
                      <CardTitle className="text-sm font-black uppercase tracking-widest">{card.title}</CardTitle>
          ...
          <section id="how-it-works" className="space-y-6">
            <div className="space-y-3">
              <p className="text-xs font-black uppercase tracking-widest text-zinc-400 ml-1">Workflow</p>
              <h2 className="text-balance text-3xl font-black tracking-tight text-foreground md:text-4xl uppercase">
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              <Card className="border-border/70 bg-card/70 shadow-none">
                <CardHeader>
                  <CardTitle className="text-sm font-black uppercase tracking-widest">Example hierarchy</CardTitle>
                  <CardDescription className="text-xs font-medium leading-normal">Namespace events with meaningful segments so filtering stays fast and intuitive.</CardDescription>
                </CardHeader>
                    ...
                    <div key={step.step} className="rounded-2xl border border-border/70 bg-card/70 p-4 hover:bg-card/80 transition-colors">
                      <div className="mb-3 flex items-center gap-3">
                        ...
                        <div className="flex items-baseline gap-2">
                          <span className="font-mono text-xs font-black uppercase tracking-widest text-primary">{step.step}</span>
          ...
          <section id="features" className="space-y-6">
            <div className="space-y-3">
              <p className="text-xs font-black uppercase tracking-widest text-zinc-400 ml-1">Capabilities</p>
              <h2 className="text-balance text-3xl font-black tracking-tight text-foreground md:text-4xl uppercase">
          ...
          <section className="space-y-6">
            <div className="space-y-3">
              <p className="text-xs font-black uppercase tracking-widest text-zinc-400 ml-1">Use Cases</p>
              <h2 className="text-balance text-3xl font-black tracking-tight text-foreground md:text-4xl uppercase">
          ...
          <section id="faq" className="space-y-6">
            <div className="space-y-3">
              <p className="text-xs font-black uppercase tracking-widest text-zinc-400 ml-1">FAQ</p>
          ...
          <section className="relative overflow-hidden rounded-2xl border border-border/70 bg-card/80 p-6 md:p-8">
            <div className="relative grid gap-6 lg:grid-cols-2 lg:items-center">
              <div className="space-y-4">
                <p className="text-xs font-black uppercase tracking-widest text-zinc-400 ml-1">Get started</p>
                <h2 className="text-balance text-3xl font-black tracking-tight text-foreground md:text-4xl uppercase">
              ...
              <div className="rounded-xl border border-border/60 bg-background/60 px-4 py-3 text-xs font-black uppercase tracking-widest text-zinc-400">
        ...
        <footer className="border-t border-border/40 bg-background/50">
          <div className="mx-auto flex w-full max-w-7xl min-w-0 flex-col gap-4 px-4 py-6 text-xs font-black uppercase tracking-widest text-zinc-500 md:flex-row md:items-center md:justify-between md:px-6">
            <div className="flex flex-wrap items-center gap-2">
